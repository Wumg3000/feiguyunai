...
class Trainer(object):
    ...
    def train(self):
        ...
        real_tensor = torch.FloatTensor(self.batch_size)
        _ = real_tensor.data.fill_(real_label)

        fake_tensor = torch.FloatTensor(self.batch_size)
        ...
        for step in trange(self.start_step, self.max_step):
            ...
            #with torch.no_grad():
            #real_tensor.detach().resize_(batch_size).fill_(real_label)
            #fake_tensor.detach().resize_(batch_size).fill_(fake_label)
